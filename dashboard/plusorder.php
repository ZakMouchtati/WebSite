    ...
    <div class="d-flex bd-highlight">
        ...
        <div class="w-100 bd-highlight" style="margin-left: 280px;">
            ...
            <div class="mt-5 text-center">
                ...
                <button type="submit" id="btntaiter" class="btn btn-md btn-success px-5 ms-5">Tariter </button>
            </div>
        </div>
    </div>
    <form action="" method="post" style="display: none;" id="formtaiter">
        <input type="text" value="<?php echo $order[0]->id ?>" name="idcommande">
    </form>
</body>
